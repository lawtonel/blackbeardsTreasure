...
import static blackbeardtreasure.lib.test.TileTest.retinaURL;
        ...
        switch (locationName) {
            case SHADE:
                ...
                Key hat1 = new Key(locationName,
                        new TextureRegion(new Texture("images/"+retinaURL()+"Hat.png"), 0,0,scale(50),scale(50)),(new Coordinates(1,11)));
                locationKeys.put(hat1.getStartPosition(), hat1);

                Key hat2 = new Key(locationName,
                        new TextureRegion(new Texture("images/"+retinaURL()+"Hat.png"), 0,0,scale(50),scale(50)),(new Coordinates(2,12)));
                locationKeys.put(hat2.getStartPosition(), hat2);

                Key hat3 = new Key(locationName,
                        new TextureRegion(new Texture("images/"+retinaURL()+"Hat.png"), 0,0,scale(50),scale(50)),(new Coordinates(1,12)));
            ...
            case CUTLASS:
                ...
                Key sword1 = new Key(locationName,
                        new TextureRegion(new Texture("images/"+retinaURL()+"sword.png"), 0,0,scale(50),scale(50)), (new Coordinates(11,1)));
                locationKeys.put(sword1.getStartPosition(), sword1);

                Key sword2 = new Key(locationName,
                        new TextureRegion(new Texture("images/"+retinaURL()+"sword.png"), 0,0,scale(50),scale(50)), (new Coordinates(12,1)));
                locationKeys.put(sword2.getStartPosition(), sword2);

                Key sword3 = new Key(locationName,
                        new TextureRegion(new Texture("images/"+retinaURL()+"sword.png"), 0,0,scale(50),scale(50)), (new Coordinates(12,2)));
            ...
            case RUM:
                ...
                Key rum1 = new Key(locationName,
                        new TextureRegion(new Texture("images/"+retinaURL()+"Rum.png"), 0,0,scale(50),scale(50)),(new Coordinates(11,12)));
                locationKeys.put(rum1.getStartPosition(), rum1);

                Key rum2 = new Key(locationName,
                        new TextureRegion(new Texture("images/"+retinaURL()+"Rum.png"), 0,0,scale(50),scale(50)),(new Coordinates(12,12)));
                locationKeys.put(rum2.getStartPosition(), rum2);

                Key rum3 = new Key(locationName,
                        new TextureRegion(new Texture("images/"+retinaURL()+"Rum.png"), 0,0,scale(50),scale(50)),(new Coordinates(12,11)));
            ...
            case PARROT:
                ...
                Key parrot1 = new Key(locationName,
                        new TextureRegion(new Texture("images/"+retinaURL()+"parrot.png"), 0,0,scale(50),scale(50)),(new Coordinates(1,1)));
                locationKeys.put(parrot1.getStartPosition(), parrot1);

                Key parrot2 = new Key(locationName,
                        new TextureRegion(new Texture("images/"+retinaURL()+"parrot.png"), 0,0,scale(50),scale(50)),(new Coordinates(1,2)));
                locationKeys.put(parrot2.getStartPosition(), parrot2);

                Key parrot3 = new Key(locationName,
                        new TextureRegion(new Texture("images/"+retinaURL()+"parrot.png"), 0,0,scale(50),scale(50)), (new Coordinates(2,1)));
            ...
            case TREASURE:
                ...
                Key treasure = new Key(locationName,
                        new TextureRegion(new Texture("images/"+retinaURL()+"treasure.png"),0,0,scale(50),scale(50)), (new Coordinates(7,6)));
